...
public class TestElectrostatic {
     ...
     * a cbrt(N)-SIZE grid.
     */
    public def generateAtoms(numAtoms : Int) : DistArray[Array[MMAtom](1){rect,zeroBased,rail}](1) {
        ...
        val atoms = DistArray.make[Array[MMAtom](1){rect,zeroBased,rail}](Dist.makeUnique(), ([p] : Point) => (tempAtoms(p) as ArrayList[MMAtom]).toArray() as Array[MMAtom](1){rect,zeroBased,rail});
        return atoms;
    }
