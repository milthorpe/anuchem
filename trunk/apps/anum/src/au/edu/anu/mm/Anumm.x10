...
public class Anumm {
     ...
     */
    public static def assignAtoms(molecule : Molecule[MMAtom]) : DistArray[Array[MMAtom](1){rect,zeroBased}](1) {
        ...
        val atoms = DistArray.make[Array[MMAtom](1){rect,zeroBased}](Dist.makeUnique(), ([p] : Point) => tempAtoms(p).toArray());
        return atoms;
    }
