...
public class TwoElectronIntegrals {
    ...
    private val fmt:Array[Double](1){rect,zeroBased}, zeroM:Array[Double](1){rect,zeroBased};
    ...
    protected def computeFmt(maxam:Int, T:Double, fmt:Array[Double](1){rect,zeroBased}) {
        if (T > 30.0){
            val invT = 1/T;
