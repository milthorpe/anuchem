...
public class PowerList { 
    ...
    val powerList = new HashMap[String,Array[Power](1){rect,zeroBased,rail}](); 
    ...
    @NonEscaping 
    public final def generatePowerList(maxAngularMomentum:Int) : Array[Power](1){rect,zeroBased,rail} {
