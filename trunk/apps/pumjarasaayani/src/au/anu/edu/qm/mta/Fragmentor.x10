...
public class Fragmentor {
   ...
   def mergeAlongConnectivity(mol:Molecule[QMAtom], sortedAtomIndices:Array[Int](1){rail}, fragList:ArrayList[Fragment]) {
       val noOfAtoms = mol.getNumberOfAtoms(); 
   ...
   def traverseAndMergeFragments(v:Int, sortedAtomIndices:Array[Int](1){rail}, mol:Molecule[QMAtom], visited:Array[Boolean](1){rail}, fragList:ArrayList[Fragment]) {
