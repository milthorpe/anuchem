...
public class CardinalityExpression {
   ...
   private def computeIntersections(fragList:ArrayList[Fragment], cfList:ArrayList[Fragment], combs:Array[Int](1){rect,zeroBased,rail}, nTerms:Int, sign:Int) : Boolean {
