...
public class LocallyEssentialTree {
    public val combinedUList : Array[Point(3)](1){rect,zeroBased};
    public val combinedVList : Array[Array[Point(3)](1){rect,zeroBased}](1){rect,zeroBased};
    public val uListMin : Array[Int](1){rect,zeroBased};
    public val uListMax : Array[Int](1){rect,zeroBased};
    public val vListMin : Array[Array[Int](1){rect,zeroBased}](1){rect,zeroBased};
    public val vListMax : Array[Array[Int](1){rect,zeroBased}](1){rect,zeroBased};
     ...
     */
    public val multipoleCopies : Array[DistArray[MultipoleExpansion](3)](1){rect,zeroBased};
     ...
     */
    public val packedAtoms : DistArray[Array[MMAtom.PackedRepresentation](1){rect,zeroBased}](3);
    
    public def this(combinedUList : Array[Point(3)](1){rect,zeroBased},
                combinedVList : Array[Array[Point(3)](1){rect,zeroBased}](1){rect,zeroBased},
                uListMin : Array[Int](1){rect,zeroBased},
                uListMax : Array[Int](1){rect,zeroBased},
                vListMin : Array[Array[Int](1){rect,zeroBased}](1){rect,zeroBased},
                vListMax : Array[Array[Int](1){rect,zeroBased}](1){rect,zeroBased}) {
        ...
        this.packedAtoms = DistArray.make[Array[MMAtom.PackedRepresentation](1){rect,zeroBased}](new PeriodicDist(Dist.makeConstant(packedAtomsRegion)));
    }
}
