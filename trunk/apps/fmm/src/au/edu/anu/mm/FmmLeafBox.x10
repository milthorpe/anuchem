...
public class FmmLeafBox extends FmmBox {
    ...
    private var uList : Array[Point(3)](1){rect,zeroBased};
    ...
    public def setUList(uList : Array[Point(3)](1){rect,zeroBased}) {
        this.uList = uList;
    }
     ...
     */
    public def getPackedAtoms() : Array[MMAtom.PackedRepresentation](1){rect,zeroBased} {
        if (atoms.size() > 0) {
