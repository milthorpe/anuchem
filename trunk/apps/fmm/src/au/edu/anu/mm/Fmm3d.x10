...
public class Fmm3d {
    ...
    protected def assignAtomsToBoxes(atoms: DistArray[Array[MMAtom](1){rect,rail}](1), lowestLevelBoxes : DistArray[FmmBox]{rank==3}, offset : Vector3d, lowestLevelDim : Int, size : Double) {
     ...
     */
    private static def getMultipolesForBoxList(thisLevelBoxes : DistArray[FmmBox](3), boxList : Array[Point(3)](1){rect,rail}) {
     ...
     */
    private static def getPackedAtomsForBoxList(lowestLevelBoxes : DistArray[FmmBox](3), boxList : Array[Point(3)](1){rect,rail}) {
    ...
    private def constructTree(numLevels : Int, topLevel : Int, numTerms : Int, ws : Int, periodic : boolean) 
      : Array[DistArray[FmmBox](3)](1){rect,rail} {
     ...
     */
    private def createLocallyEssentialTrees(numLevels : Int, topLevel : Int, boxes : Array[DistArray[FmmBox](3)](1){rect,rail}, periodic : Boolean) : DistArray[LocallyEssentialTree]{rank==1} {
        ...
        finish ateach ([p1] in locallyEssentialTrees) {
            ...
            val combinedVList = new Array[Array[Point(3)](1){rect,rail}](numLevels+1);
            val vListMin = new Array[Array[Int](1){rect,rail}](numLevels+1);
            val vListMax = new Array[Array[Int](1){rect,rail}](numLevels+1);
            for ([thisLevel] in topLevel..numLevels) {
    ...
    protected static def getParentForChild(boxes : Array[DistArray[FmmBox](3)](1){rect,rail}, level : Int, topLevel : Int, x : Int, y : Int, z : Int) : GlobalRef[FmmBox] {
        if (level == topLevel)
