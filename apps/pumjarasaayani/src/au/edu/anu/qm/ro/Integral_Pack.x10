...
public class Integral_Pack {
    ...
    @Native("c++", "(#this)->GenclassY((double*)&((#1).x10__i), (double*)&((#2).x10__i), (#3)->raw().raw(), (#4)->raw().raw(), (#5), (#6), (#7), (#8)->raw().raw())")
     ...
     */
    @Native("c++", "(#this)->Genclass((#1), (#2), (double*)&((#3).x10__i), (double*)&((#4).x10__i), (#5)->raw().raw(), (#6)->raw().raw(), (#7)->raw().raw(), (#8)->raw().raw(), (#9), (#10), (#11)->raw().raw(), (#12), (#13), (#14)->raw().raw(), (#15))")
