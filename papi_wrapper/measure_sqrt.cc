...
static double doAMillionSqrts(double a[]) {
#ifdef USEPAPI
    ...
    PAPI_add_event(EventSet, PAPI_FSQ_INS);
    ...
    printf("cycles: %16lld total ins: %16lld FP ins: %16lld SQRT: %16lld\n", cycles, totals[0], totals[1], totals[2]);
    printf("cycles/sqrt %f\n",  cycles / 1e6);
#endif
