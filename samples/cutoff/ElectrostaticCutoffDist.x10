 ...
 */
public class ElectrostaticCutoffDist extends TestElectrostatic {
    ...
    public static def main(args : Rail[String]) {
        ...
        new ElectrostaticCutoffDist(size, cutoff).test(numAtoms);
    }
    ...
    public def test(numAtoms:Int) {
        ...
        logTime("Setup",             ElectrostaticCutoffDist.TIMER_INDEX_SETUP,         timer);
        logTime("Prefetch",          ElectrostaticCutoffDist.TIMER_INDEX_PREFETCH,      timer);
        logTime("Direct",            ElectrostaticCutoffDist.TIMER_INDEX_DIRECT,        timer);
    }
